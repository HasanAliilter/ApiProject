...
namespace Api.Application.Interface.AutoMapper
{
    public interface IMapper
    {
        TDestination Map<TDestination, TSource>(TSource source, string? ignore = null); //mapper.Map<BrandDto, Brand>(brand) brand bir Brand nesnesidir
